 ...
 * be non-deferred. These are core tools provided by eNif or dynamically
 * injected tools.
 */
const additionalNonDeferredToolNames = new Set<string>([
	// Core tools provided by eNif (not registered via ToolRegistry.registerTool)
	...
	'task_complete',
	// eNif built-in language tools that should always be available
	'vscode_renameSymbol',
