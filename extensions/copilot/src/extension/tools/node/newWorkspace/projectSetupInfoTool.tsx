...
const setupInfo: ProjectSetupInfo[] = [
	{
		...
		description: 'A template for creating a eNif extension using Yeoman and Generator-Code.',
		executionCommands: [{
	...
	},
	{
		...
		rules: [
			'Follow these rules strictly and do not deviate from them.',
			`1. Call the tool ${ToolName.RunVscodeCmd} to correctly create a new Python script project in eNif. Call the command with the following arguments.`,
	...
	},
	{
		...
		rules: [
			'Follow these rules strictly and do not deviate from them.',
			`1. Call the tool ${ToolName.RunVscodeCmd} to correctly create a new Python package project in eNif. Call the command with the following arguments:`,
