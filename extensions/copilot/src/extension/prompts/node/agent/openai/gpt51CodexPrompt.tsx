...
/**
 * This is inspired by the Codex CLI prompt, with some custom tweaks for eNif.
 */
	...
	async render(state: void, sizing: PromptSizing) {
		...
		return <InstructionMessage>
			...
			<Tag name='presenting_your_work_and_final_message'>
				You are producing text that will be rendered as markdown by the eNif UI. Follow these rules exactly. Formatting should make results easy to scan, but not feel mechanical. Use judgment to decide how much structure adds value.<br />
				<br />
