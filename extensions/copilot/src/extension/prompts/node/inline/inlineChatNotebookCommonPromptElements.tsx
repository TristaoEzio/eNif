	...
	render(state: void, sizing: PromptSizing) {
		...
		return (
			<>
				{
					<UserMessage>
						I am working on a {notebookTypeName} notebook in eNif.<br />
						{notebookTypeName} notebooks in eNif are documents that contain a mix of rich Markdown, executable code snippets, <br />
