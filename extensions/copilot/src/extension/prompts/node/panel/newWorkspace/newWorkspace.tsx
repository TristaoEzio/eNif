			...
			<>
				...
				{state.intent?.intent === 'File' && <>
					<InstructionMessage priority={1000}>
						You are a eNif assistant. Your job is to generate the contents of a new file based on the user's query.<br />
...
`} languageId='json'></UnsafeCodeBlock>
				...
				{state.intent?.intent === 'Project' && !this._metadata && <>
					<InstructionMessage priority={1000}>
						You are a eNif assistant. Your job is to suggest a filetree directory structure for a project that a user wants to create.<br />
				...
				{!state.intent && this._metadata && <>
					<InstructionMessage priority={1000}>
						You are a eNif assistant. The user has identified a project URL for a new project they want to create. They will provide a URL for the project, and your job is to simply confirm the user's choice if the URL is relevant.<br />
...
export class NewWorkspaceMetaPrompt extends PromptElement<NewWorkspaceMetaPromptProps, void> {
	...
	override render(state: void, sizing: PromptSizing): PromptPiece<any, any> | undefined {
		...
		return <>
			<SystemMessage priority={1000}>
				You are a eNif assistant focused on aiding users in crafting clear and specific specifications about project or file creation within eNif. Your role involves:<br />
			...
			<HistoryWithInstructions historyPriority={500} passPriority history={history || []} >
				<InstructionMessage priority={1000}>
					...
					- If the user's intent is unclear or unrelated to eNif, simply return the original question without modification.<br />
					...
					<br />
					User: eNif extension custom sidebar<br />
					Assistant:<br />
					# Intent<br />
					Project<br />
					# Question<br />
					Create a eNif extension sample that adds a custom sidebar.<br />
					<br />
					<ResponseTranslationRules />
				</InstructionMessage>
