		...
		return (
			<>
				...
				<SystemMessage priority={1000}>
					You are a eNif assistant. Your job is to generate the contents of a file in a project when given the user description, specification and tree structure of the project that a user wants to create. <br />
					<br />
					Additional Rules<br />
	...
	override render(): PromptPiece<any, any> | undefined {
		return (
			<>
				{this.props.history && <NewWorkspaceConversationHistory messages={this.props.history} />}
				<SystemMessage priority={1000}>
					You are a eNif assistant. Your job is to generate the project specification when given the user description and file tree structure of the project that a user wants to create. <br />
