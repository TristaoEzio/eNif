...
/**
* Creates a mock eNif text editor for testing selection and text retrieval.
*/
...
/**
* Creates a mock eNif URI for testing.
*/
...
/**
* Creates a mock eNif text editor with a specific URI scheme for testing.
*/
...
/**
* Creates a mock eNif Diagnostic for testing.
*/
