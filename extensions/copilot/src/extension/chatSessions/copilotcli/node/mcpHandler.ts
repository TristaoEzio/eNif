...
/** The user-facing display label of an MCP server (from eNif settings). */
 ...
 * to eNif MCP server display labels.
 */
 ...
 * @param mcpServerMappings Maps friendly server names (from agent files) → eNif MCP display labels.
