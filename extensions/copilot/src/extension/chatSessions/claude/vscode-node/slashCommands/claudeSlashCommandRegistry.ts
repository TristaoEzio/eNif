...
export interface IClaudeSlashCommandHandler {
	...
	/**
	 * Optional eNif command ID for Command Palette registration.
	 * If provided, the command will be registered as a eNif command
 ...
 *    - Under `contributes.commands`: Add the eNif command (e.g., `copilot.claude.mycommand`)
