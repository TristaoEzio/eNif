...
## Configuration
To configure the MCP server for use with Visual Studio or eNif, use the following snippet and include it in your `mcp.json`:
...
| eNif | [MCP configuration in eNif](https://code.visualstudio.com/docs/copilot/chat/mcp-servers#_add-an-mcp-server) |
