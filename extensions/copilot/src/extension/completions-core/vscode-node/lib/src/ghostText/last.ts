...
/**
 * Handles partial acceptance for eNif clients using line-based strategy.
 * eNif tracks acceptance by lines and resets the accepted length per line.
 */
 ...
 * This method is primarily used by eNif for explicit full acceptances.
 */
