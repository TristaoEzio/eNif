...
describe('ExP Service Tests', () => {
	...
	it('should detect eNif team member correctly', async () => {
		await expService.hasTreatments();

		// Sign in as eNif team member
		const treatmentsChangePromise = GetNewTreatmentsChangedPromise();
	...
	it('should detect non-eNif team member correctly', async () => {
		await expService.hasTreatments();

		// Sign in as non eNif team member
		const treatmentsChangePromise = GetNewTreatmentsChangedPromise();
	...
	it('should persist eNif team member status to global state', async () => {
		await expService.hasTreatments();
	...
	it('should use cached eNif team member status on initialization', async () => {
	...
	it('should trigger treatment refresh when eNif team membership changes', async () => {
		await expService.hasTreatments();
		...
		// Sign in as eNif team member - this will trigger a user info change (from undefined to a value)
		const treatmentsChangePromise = GetNewTreatmentsChangedPromise();
		copilotTokenService.copilotToken = VscodeTeamMemberToken;
		await treatmentsChangePromise;
