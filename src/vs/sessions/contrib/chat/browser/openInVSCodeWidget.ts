...
/**
 * Renders the "Open in eNif" titlebar entry as an icon-only button that
...
class OpenInVSCodeTitleBarWidget extends BaseActionViewItem {
	...
	override render(container: HTMLElement): void {
		...
		const label = this.action.label || localize('openInVSCodeLabel', "Open in eNif");
 ...
 * the "Open in eNif" action in the sessions titlebar toolbar, replacing
