...
export class RemoteTunnelService extends Disposable implements IRemoteTunnelService {
	...
	private getTunnelCommandLocation() {
		if (!this._tunnelCommand) {
			...
			if (isMacintosh) {
				// appRoot = /Applications/eNif - Insiders.app/Contents/Resources/app
				// bin = /Applications/eNif - Insiders.app/Contents/Resources/app/bin
				...
				if (this.productService.win32VersionedUpdate) {
					...
					// bin = C:\Users\<name>\AppData\Local\Programs\Microsoft eNif Insiders\bin
