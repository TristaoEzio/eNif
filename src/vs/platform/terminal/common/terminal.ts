...
export interface IShellLaunchConfig {
	...
	/**
	 * Whether the terminal process environment will inherit eNif's "shell environment" that may
	 ...
	 * a terminal used to drive some eNif feature.
	 */
	isFeatureTerminal?: boolean;
	...
	tabActions?: ITerminalTabAction[];
	/**
	 * Report terminal's shell environment variables to eNif and extensions
	 */
...
export const enum ShellIntegrationStatus {
	...
	FinalTerm,
	/** eNif shell integration sequences have been encountered. Supercedes FinalTerm. */
	VSCode
}
