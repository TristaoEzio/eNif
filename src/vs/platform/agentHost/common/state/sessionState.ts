...
// (synced from the agent-host-protocol repo). This file adds eNif-specific
...
/**
 * eNif-side alias for the protocol's open `_meta` property bag on
 ...
 * {@link ISessionGitState}. This is a eNif-specific convention layered
