...
/**
 * Allows webviews to monitor when an element in the eNif editor is being dragged/dropped.
 *
 * This is required since webview end up eating the drag event. eNif needs to see this
