 ...
 * {@link IDetachedTerminalInstance} (a terminal used elsewhere in eNif UI).
 */
 ...
 * to represent terminals that appear in other parts of the eNif UI outside
...
export interface IXtermTerminal extends IDisposable {
	...
	*/
	...
	/**
	 * Selects the content between the two markers by their eNif OSC `SetMarker`
...
export interface IDetachedXtermTerminal extends IXtermTerminal {
	...
	/**
	 * Updates the xterm log level to match the given eNif log level.
	 */
	updateLogLevel(): void;
