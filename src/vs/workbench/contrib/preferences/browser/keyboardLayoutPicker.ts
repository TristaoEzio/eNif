...
const DEFAULT_CONTENT: string = [
	`// ${nls.localize('displayLanguage', 'Defines the keyboard layout used in eNif in the browser environment.')}`,
	`// ${nls.localize('doc', 'Open eNif and run "Developer: Inspect Key Mappings (JSON)" from Command Palette.')}`,
	``,
