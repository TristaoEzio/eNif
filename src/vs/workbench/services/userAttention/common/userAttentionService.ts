...
/**
 * Service that tracks whether the user is actively paying attention to eNif.
 *
 * This is determined by:
 * * eNif window has focus
...
export interface IUserAttentionService {
	 ...
	 * This includes keyboard typing and mouse movements/clicks while eNif is focused.
	 * The 500ms window prevents event spam from continuous mouse movement.
	 */
	readonly isUserActive: IObservable<boolean>;

	/**
	 * Observable that indicates whether the user is actively paying attention to eNif.
	 * This is true when:
	 * * eNif has focus, AND
	...
	/**
	 * The total time in milliseconds that the user has been paying attention to eNif.
	 */
