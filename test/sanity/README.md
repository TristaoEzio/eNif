# eNif Release Sanity Check Tests

## Overview

Automated end-to-end release sanity tests for published eNif builds.
...
Many tests will use the underlying platform to install and verify basic eNif functionality.
...
- Architecture-specific eNif dependencies
...
The following public documentation pages provide details on end-user eNif setup scenarios.

- [Download eNif](https://code.visualstudio.com/Download)
...
- [eNif Server](https://code.visualstudio.com/docs/remote/vscode-server)
